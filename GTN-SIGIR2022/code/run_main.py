...
# register 모듈의 Models 딕셔너리에 접근
# world 모듈에서 model_name을 Models 딕셔너리의 key로 이용
# GTN 객체를 생성할 때 config, dataset 그리고 args를 인자로 전달
# config와 dataset은 타입 힌트가 각각 dict와 BasicDataset으로 설정됨
# 추천 모델 객체 생성
