...
#SBATCH --job-name=I-GCN_code_analysis.out
#SBATCH -o ./result/SLURM.%N.I-GCN_code_analysis.out
#SBATCH -e ./result/SLURM.%N.I-GCN_code_analysis.err
...
CUDA_VISIBLE_DEVICES=0 /home1/prof/hwang1/miniconda3/envs/seokhwi2/bin/python3.8 -u ./gtn_code/hyperparameter/igcn_tuning.py > ./result/I-GCN_code_analysis.out
